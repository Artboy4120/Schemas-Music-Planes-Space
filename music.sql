...
VALUES
  ...
  ('Shallow', 216, '2018-09-27', 5, 4, 4),
  ('How You Remind Me', 223, '2001-08-21', 7, 5, 5),
  ('New York State of Mind', 276, '2009-10-20', 8, 6, 6),
  ('Dark Horse', 215, '2013-12-17', 9, 7, 7),
  ('Moves Like Jagger', 201, '2011-06-21', 11, 8, 8),
  ('Complicated', 244, '2002-05-14', 14, 9, 9),
